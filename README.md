# 公众号听读 / wechat-article-tts

边听边看微信公众号文章。公众号听读会在文章原页面使用浏览器本地语音朗读正文，并逐句高亮当前内容、自动滚动、记住阅读进度。
...
![公众号听读底部播放器](store-assets/screenshots/screenshot-1-main-player.png)
...
公众号听读不上传文章正文，不接入远程语音服务，也不使用远程代码。扩展会在本地读取当前公众号文章正文，用于句子切分、高亮和 Chrome TTS 朗读。
